                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <!-- <h4 class="card-title">Validasi
                            <a href="{{url('admin/pengajuan/create')}}" class="btn btn-secondary float-right"><i class="fa fa-plus"></i>Tambah Data</a>
                        </h4> -->
                                </div>
                                <!--end card-header-->
                                                                ...
                                                                <td>
                                                                    <center>
                                                                        <div class="btn-group-center">
                                                                            <a href="{{url('admin/validasi',$pengabdi->id)}}" class="btn btn-outline-primary"><i class="fa fa-info"></i></a>
