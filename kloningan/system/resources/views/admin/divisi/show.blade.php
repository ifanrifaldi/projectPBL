            ...
            <div class="row">
                <div class="col">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{url('admin/divisi')}}"><i class="fas fa-arrow-left"></i> Back</a></li>
...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header bg-primary">
                    <h4 class="card-title" style="color: white;">Daftar Pegawai</h4>
                                ...
                                <div class="modal fade" id="edit{{ $pegawai->id }}" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <form action="{{ url('admin/divisi/editpegawai',$pegawai->id) }}" method="post">
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header bg-primary">
                                                    <h5 class="modal-title" id="staticBackdropLabel" style="color: white;">Edit Data Pegawai</h5>
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                    </button>
                                                </div>
