        ...
        <div class="page-title-box">
            <div class="row">
                <div class="col">
                    ...
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item active">Show Dashboard</li>
                    </ol>
                </div>
                <!--end col-->
...
<center>
    ...
    <h5 style="color: #1761fd;"> di Sistem informasi Pengadaan Barang dan Jasa YIARI</h5>
</center>
...
<script>
    ...
    new Chart(ctx, {
        type: 'bar',
        data: {
            labels: ['TotalPengajuan', 'Pengajuan Diproses', 'Pengajuan Disetujui', 'Pengajuan Ditolak'],
            datasets: [{
                label: 'Grafik Data',
