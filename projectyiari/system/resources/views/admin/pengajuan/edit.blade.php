    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 mt-5">
                <form action="{{ url('admin/pengajuan/edit') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="nomor" value="{{$pengajuan->nomor}}">
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="" class="control-label">Tanggal Pengajuan</label>
                                        <input type="date" class="form-control" name="tanggal_pengajuan" value="{{$pengajuan->tanggal_pengajuan}}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="" class="control-label">Tanggal Dibutuhkan</label>
                                        <input type="date" class="form-control" name="tanggal_dibutuhkan" value="{{$pengajuan->tanggal_dibutuhkan}}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="nama_pengaju" value="{{$pengajuan->nama_pengaju}}">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="status_pengajuan" id="">
                                            ...
                                            <option value="diterima" @if ($pengajuan->status_pengajuan == 'diterima')
                                                selected
                                            @endif> diterima</option>
                                            <option value="ditolak" @if ($pengajuan->status_pengajuan == 'ditolak')
                                                selected
