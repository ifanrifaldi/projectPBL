...
<div class="page-content">
    <div class="container-fluid">
        ...
        <h4 class="card-title mb-5">
            <a href="{{url('admin/pengajuan/create')}}" class="btn btn-primary float-right"><i class="fa fa-plus"></i>Tambah Data</a>
        </h4>
        <br>
        <div class="row">
            <div class="col-12">
                                                            ...
                                                            <td>
                                                                <center>
                                                                    <div class="btn-group-center">
                                                                        <a href="{{url('admin/pengajuan',$pengabdi->id)}}" class="btn btn-primary"><i class="fa fa-info"></i></a>
                                                                        <a href="{{url('admin/pengajuan',$pengabdi->id)}}/edit" class="btn btn-outline-secondary"><i class="fa fa-edit"></i></a>
