...
<html lang="en">
    ...
    <head>
        ...
        <!-- App favicon -->
        <link rel="shortcut icon" href="{{url('public')}}/assets/images/iar.png">
    ...
    <body class="dark-sidenav">
        <!-- Left Sidenav -->
        @include('templatedivisi.side')
        <!-- end left-sidenav-->


        <div class="page-wrapper">
            <!-- Top Bar Start -->
            @include('templatedivisi.top')
            <!-- Top Bar End -->
            ...
            <div class="page-content">
                <div class="container-fluid">
                    <!-- Page-Title -->
                    @include('templatedivisi.utils.notif')
                    @yield('content')
