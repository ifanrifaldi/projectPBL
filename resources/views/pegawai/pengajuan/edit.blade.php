    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 mt-5">
                <form action="{{url('pegawai/pengajuan', $pembelian->id)}}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method("PUT")
                    <div class="card">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="nama" value="{{$pembelian->nama_pengaju}}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="class">
                                            <option>{{$pembelian->kategori}}</option>
