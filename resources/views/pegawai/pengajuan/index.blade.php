            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Data Pembelian
                        <a href="{{url('pegawai/pengajuan/create')}}" class="btn btn-info float-right"><i class="fa fa-plus"></i>Tambah Data</a>
                    </h4>
                </div>
                <!--end card-header-->
                <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group float-right">
                                            <a href="{{url('pegawai/pengajuan', $pembelian->id)}}" class="btn btn-dark"><i class="fa fa-info"></i></a>
                                            <a href="{{url('pegawai/pengajuan', $pembelian->id)}}/edit" class="btn btn-warning"><i class="fa fa-edit"></i></a>
                                            @include('template.utils.delete', ['url'=>url('pegawai/pengajuan', $pembelian->id)])
                                        </div>
                                    </td>
                                </tr>
                                @endforeach
