                    ...
                    <ul class="list-unstyled topbar-nav float-right mb-0">  
                            ...
                            <div class="dropdown-menu dropdown-menu-right dropdown-lg pt-0">
                                ...
                                <div class="notification-menu" data-simplebar>
                                    ...
                                    <a href="#" class="dropdown-item py-3">
                                        ...
                                        <div class="media">
                                            <div class="avatar-md bg-soft-primary">
                                                <img src="public/assets/images/users/user-4.jpg" alt="" class="thumb-sm rounded-circle">
                                            </div>
                                            <div class="media-body align-self-center ml-2 text-truncate">
                                    ...
                                    <a href="#" class="dropdown-item py-3">
                                        ...
                                        <div class="media">
                                            <div class="avatar-md bg-soft-primary">
                                                <img src="public/assets/images/users/user-5.jpg" alt="" class="thumb-sm rounded-circle">
                                            </div>
                                            <div class="media-body align-self-center ml-2 text-truncate">
                                                <h6 class="my-0 font-weight-normal text-dark">Your order is placed</h6>
                                                <small class="text-muted mb-0">It is a long established fact that a reader.</small>
                        ...
                        <li class="dropdown">
                            <a class="nav-link dropdown-toggle waves-effect waves-light nav-user" data-toggle="dropdown" href="#" role="button"
                                ...
                                <img src="public/assets/images/users/user-5.jpg" alt="profile-user" class="rounded-circle" />                                 
                            </a>
