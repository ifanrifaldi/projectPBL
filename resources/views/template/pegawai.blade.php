...
<html lang="en">
    ...
    <head>
        ...
        <meta content="Premium Multipurpose Admin & Dashboard  name="dpegawai.escription" />
    ...
    <body class="dark-sidenav">
        <!-- Left Sidenav -->
        @include('section.pegawai.sidebar')
        <!-- end left-sidenav-->
        

        <div class="page-wrapper">
            <!-- Top Bar Start -->
            @include('section.pegawai.header')
            <!-- Top Bar End -->
            ...
            <div class="page-content"> 
               ...
               @include('section.pegawai.footer')
            </div>
            <!-- end page content -->
        </div>
        <!-- end page-wrapper -->
        ...
        <!-- Edit Tables -->
        <script src="{{url('public/assets')}}/plugins/tiny-editable/mindmup-editabletable.js"></script>
        <script src="{{url('public/assets')}}/plugins/tiny-editable/numeric-input-example.js"></script>
        <script src="{{url('public/assets')}}/plugins/bootable/bootstable.js"></script> 
        <script src="{{url('public/assets')}}//pages/jquery.tabledit.init.js"></script>
