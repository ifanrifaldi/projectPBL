            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">    
                        ...
                        <br>
                        <button class="btn btn-danger  float-right"><h6><i class="fa fa-save"></i>Tolak</h6></button>
                    
                        <button class="btn btn-info float-right" style="background-color: rgb(56, 204, 209);"><h6><i class="fa fa-save"></i>Setujui</h6></button>
                    </div><!--end card-body-->
                </div><!--end card-->
            </div> <!-- end col -->
        </div> <!-- end row -->
