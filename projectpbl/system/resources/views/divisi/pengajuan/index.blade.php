                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header bg-primary">
                            <h4 class="card-title" style="color: white;">Data Pengajuan {{$pegawai->divisi->nama_divisi}}</h4>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                                ...
                                                <table id="datatable" class="table table-bordered dt-responsive nowrap " style="border-collapse: collapse; border-spacing: 0px; width: 100%;" role="grid" aria-describedby="datatable_info">
                                                    <thead>
                                                        <tr role="row">
                                                            ...
                                                            <h4>
                                                                <a href="{{url('divisi/pengajuan/create')}}" class="btn btn-outline-primary float-right"><i class="fa fa-plus"></i> Tambah Data</a>
                                                            </h4>
                                                        </tr>
                                                    </thead>
