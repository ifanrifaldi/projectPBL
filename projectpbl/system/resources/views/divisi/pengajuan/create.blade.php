                ...
                <form action="{{ url('divisi/pengajuan') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card">
                        <div class="card-header bg-primary">
                            <h4 class="card-title" style="color: white;">Ajukan Pembelian</h4>
                                        ...
                                        <table class="table  table-bordered" id="makeEditable">
                                            ...
                                            <tbody id="tbody">
                                                <tr class="success">
                                                    ...
                                                    <td>
                                                        <input type="file" class="form-control" name="foto[]" accept=".png,.jpg,.webp,.jfif,">
                                                    </td>
                                                    <td>
...
<tr class="success">
    ...
    <td>
        <div class="btn btn-danger" onclick="hapusBaris(this)" >Hapus</div>
    </td>
</tr>    
`

const hapusBaris = self => $(self).parent().parent().remove()
