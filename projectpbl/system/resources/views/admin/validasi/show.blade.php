                    ...
                    <table class="table table-striped mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="#" id="inline-username" data-type="text" data-pk="1" data-title="Enter username">{{$list_detail->created_at->format("d F Y")}}</a>
                                </td>
                            </tr>
                            <tr>
                                <td>Tanggal Dibutuhkan:</td>
                                <td>
                                    <a href="#" id="inline-username" data-type="text" data-pk="1" data-title="Enter username">{{date("d F Y",strtotime($list_detail->tgl_dibutuhkan))}}</a>
                                </td>
                            </tr>
                            <tr>
                                <td>Nama Pengaju:</td>
